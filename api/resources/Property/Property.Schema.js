...
const mongooseObject = {
  ...
  propertyType: { type: String, enum: ["flat", "house", "villa", "pg", "independent_house", "other"], required: true },
  listingType: { type: String, enum: ["whole", "rooms"], default: "rooms", index: true },
  bhkType: String,
  size: Number,
  floor: Number,
  totalFloors: Number,
